...
describe('[App]', function()
  ...
  it('should accept few options', function()
    App:start({
      name    = 'Demo',
      version = '2.6.0'
    })
  ...
  it('should open a view directly', function()
    App:start({
      ENV = 'view-testing'
    })
  end)

  it('should start as production', function()
    App:start({
      ENV = 'production'
    })
  end)

  it('should start as iOS', function()
    system.switchPlatform('iPhone OS')
    App:start()
    system.switchPlatform('Android')
  end)

  it('should override colors', function()
    App:start({
      colors = {
        'DA1D38', -- #DA1D38
        'ffe35b', -- #ffe35b
  ...
  it('should listen key events', function()
    App:start()
  ...
  it('should send device notifications', function()
    App:start()
  ...
  it('should calculate value depending on screen ratio', function()
