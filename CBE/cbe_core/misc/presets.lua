...
--------------------------------------------------------------------------------
presets.supported = {
	vents = {"aurora", "wisps", "beams", "burn", "circles", "confetti", "embers", "evil", "flame", "fluid", "fountain", "hyperspace", "lasergun", "rain", "smoke", "snow", "sparks", "steam", "water", "waterfall"},
...
presets.vents = {
    ...
    wisps = {
		title = "wisps",
		positionType = "atPoint",
		build = function() local size = math_random(20, 180) return display_newImageRect(glowTexture, size, size) end,
        color={{1, 1, 0}, {0, 1, 0}},
        emitDelay = 30,
        perEmit = 1,
        emissionNum = 0,
        ...
        endAlpha = 0,
        fadeInTime = 2500,
        onUpdate = function(particle,  vent)particle:applyForce((vent.emitX * 0.01) - (particle.x * 0.01),  0)end,
        physics = {
            angles={{30, 150}},
            gravityX = 0,
            gravityY=-0.02
